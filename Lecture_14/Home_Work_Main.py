...
# file_path = helper.create_json_file("Home_Work_14/Home_Work_jsons", "Chess_Players")

# helper.write_data_into_json_file(file_path, chess_players)

# file_content = helper.read_json_file(file_path)
# print(file_content)
...
# for player in Chess_Players_Add:
#   helper.update_json_file(file_path, player)
